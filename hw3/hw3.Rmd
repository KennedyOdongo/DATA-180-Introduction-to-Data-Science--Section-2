...
```{r}
ggplot(Cars93, aes(x=EngineSize,y= MPG.city))+ geom_point(col= "blue", size= 2) + xlim(NA, 6) + ylim(NA, 55) + labs(title = "Engine Size to MPG in the city", subtitle = "Scatterplot", caption = "Engine Size") + ylab("Miles Per Gallon")
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y= MPG.city, color= Type))+ geom_point( size= 2) + xlim(NA, 6) + ylim(NA, 55) + labs(title = "Engine Size to MPG in the city", subtitle = "Scatterplot", caption = "Engine Size") + ylab("Miles Per Gallon") + xlab("Engine Size")
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y= MPG.city, color= Type))+ geom_point( size= 2) + xlim(NA, 6) + ylim(NA, 55) + labs(title = "Engine Size to MPG in the city", subtitle = "Scatterplot", caption = "Engine Size") + ylab("Miles Per Gallon") + xlab("Engine Size") + geom_smooth(col= "red", linetype= "dashed")
```
...
```{r}
ggplot(Cars93, aes(x= AirBags, color= AirBags))+ geom_bar() + labs(title = "Barplot of Airbags", subtitle = "Barplot", caption = "Airbags") + ylab("Count") + xlab("Type of AirBags")
```
...
```{r}
ggplot(Cars93, aes(x= Origin, fill= AirBags))+ geom_bar(position = "dodge") + labs(title = "Barplot of Airbags and Car Origin", subtitle = "Barplot", caption = "Car Origin Type") + ylab("Count") + xlab("Car Origin and AirBag configuration")
```
...
```{r}
ggplot()+ geom_sf(data= au_states$geometry, color= "white", fill= "green")+ labs(title = "Australian map")
```
...
```{r}
ggplot()+ geom_sf(data= au_states$geometry, color= "white", aes(fill= au_states$NAME))+ labs(title = "Australian map")
...
```{r}
ggplot() + geom_sf(data= au_states$geometry, color= "white", fill= "green")+ geom_point(data = au_capitals, aes(lon, lat), col="red", size=2) + labs(title = "Australian map")
...
```{r}
ggplot() + geom_sf(data= au_states$geometry, color= "white", fill= "green")+ labs(title = "Australian map") + coord_sf(crs= st_crs(3112))
